...
<form class="form-horizontal" role="form" action="process/update_block.php" method="post">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-6">
            <button type="submit" class="button btn btn-default" name="update_block" id="update_block">Update</button>
        </div>
    </div>
</form>
...
<script>
    $("#block").change(function()
    {
        ...
        $.ajax
                ({
                    type: "POST",
                    url: "forms/ajax_blockupdate.php",
                    data: dataString,
                    cache: false,
