...
if ($errflag == 0) {
    ...
    $date = date('Y-m-d');
    $sql = "INSERT INTO `ofm`.`sheet4` (`season`, `crop`, `farmers`, `land`, `submitting_date`, `aez`, `district`, `subdistrict`, `union_id`, `ecoyear`, `boron`, `alluminium_salfet`, `magnesium_salfet`, `zinc_salfet`, `jipsam`, `mpks`, `dmp`, `tsp`, `uria`) "
